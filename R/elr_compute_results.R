...
computeResults <- function(obj){
  ...
  m1 <- computeLavaanResults(obj)
  hypotheses <- computeHypothesesResults(obj, m1)
  ...
  sdyx0 <- computeStdDevEffectSize(obj, est, m1)
...
computeHypothesesResults <- function(obj, m1){
...
computeStdDevEffectSize <- function(obj, est, m1){
